import { GiLotus, GiMeditation, GiHealthNormal, GiBodyBalance, GiHealing } from 'react-icons/gi';
import { FaLaptopHouse, FaBriefcase, FaUserFriends } from 'react-icons/fa';
...

{
...

  {
    ...
    shortDescription:
      'One-on-one sessions tailored to your body, goals, and pace — in studio or at home.',
    description:
      'Work directly with a certified yoga trainer on a plan built around your body and goals — whether that is flexibility, strength, injury recovery, or stress relief. Sessions are available in-studio or in the comfort of your home.',
    keyword: 'Yoga Trainer',
  },
  {
    ...
    shortDescription:
      'Live, instructor-led yoga streamed to your home — flexible schedules for every time zone.',
    description:
  ...
  },
 {
 ...
 
  {
    ...
    shortDescription:
      'Ayurvedic detox therapy for cleansing and rejuvenation',
    description:
